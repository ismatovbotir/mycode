...
<div class="p-6">
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-gray-900">Create Entity</h1>
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-6">
        <form method="POST" action="{{ route('admin.entities.store') }}" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="type" id="type" value="{{ old('type') }}" placeholder="e.g., demand, cashin"
            ...
            <div class="grid grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="translations[uz]" id="uz" value="{{ old('translations.uz') }}" placeholder="e.g., Buyurtma"
                ...
                <div>
                    ...
                    <input type="text" name="translations[en]" id="en" value="{{ old('translations.en') }}" placeholder="e.g., Demand"
                ...
                <div>
                    ...
                    <input type="text" name="translations[ru]" id="ru" value="{{ old('translations.ru') }}" placeholder="e.g., Заказ"
